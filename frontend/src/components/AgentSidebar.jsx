...
const AgentSidebar = ({ isCollapsed, isMobileOpen, onCloseMobile }) => {
  ...
  const navItems = [
    { name: "Dashboard", path: "/agentdashboard", icon: FaChartPie },
    { name: "Claims Queue", path: "/viewallclaim", icon: FaFolderOpen },
  ];

  const content = (
    <div className="h-full flex flex-col justify-between py-5 bg-gradient-to-b from-[#111827] to-[#0f172a] text-slate-300">
      <div>

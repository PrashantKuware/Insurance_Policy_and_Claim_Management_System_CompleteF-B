...
const AgentLayout = ({ children }) => {
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex overflow-hidden text-slate-800 dark:text-slate-300 transition-colors duration-300">

            {/* SIDEBAR WRAPPER: z-50 सुनिश्चित करता है कि यह हमेशा टॉप पर रहे */}
            <div className="hidden md:block fixed left-0 top-0 h-screen w-72 z-50 border-r border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-950 transition-colors duration-300">
                <AgentSidebar />
            </div>
            ...
            <div className="flex-1 md:ml-72 flex flex-col h-screen min-w-0 ">
                ...
                <main className="flex-1 overflow-y-auto p-4 md:p-8 relative bg-slate-50/50 dark:bg-slate-950/50 transition-colors duration-300">
